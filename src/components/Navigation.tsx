  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Name/Logo */}
        <motion.div
          className="text-xl md:text-2xl font-light text-white cursor-pointer select-none tracking-wide"
        ...
        <motion.button
          ...
          className="group relative overflow-hidden px-8 py-3 bg-white/5 backdrop-blur-xl border border-white/10 rounded-full text-white font-medium hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-lg hover:shadow-xl"
          whileHover={{ 
            scale: 1.02,
