...
const projects = [
  {
    ...
    tech: ["Node.js", "MongoDB", "Express.js", "Docker"],
  ...
  },
  {
    ...
    tech: ["ASP.NET Core", "C#", "Entity Framework", "SQL server","JWT Auth"],
  ...
  },
  {
    ...
    tech: ["React", "Laravel", "MySQL", "PHP","JWT Auth", "Docker", "Git", "Figma", "Tailwind CSS", "REST API"],
